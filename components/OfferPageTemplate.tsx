...
interface OfferPageTemplateProps {
    hotelName: string; // Used for "luvicaveotel" replacement if needed, though design is mostly static text except price/region
    price: string;
    region: string;
}

export default function OfferPageTemplate({ hotelName, price, region }: OfferPageTemplateProps) {
    return (
                                ...
                                <ul className="space-y-6">
                                    ...
                                    <li className="flex gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-400 text-sm mt-1">“{region}{getLocativeSuffix(region)} Nerede Kalınır?” gibi rehber içeriklerde otelinizin önerilmesi</p>
                                        </div>
                                    </li>
                                    ...
                                    {/* Item 7 - DYNAMIC REGION */}
                                    <li className="flex gap-4">
                                        <div className="flex-shrink-0 w-6 h-6 rounded-full bg-green-500/20 flex items-center justify-center mt-1">
                                            <Check className="w-4 h-4 text-green-400" />
                                        </div>
                                        <div>
                                            <h4 className="text-white font-bold text-lg">{region}{getAblativeSuffix(region)} Sınırlı Sayıda Seçilmiş Otel</h4>
